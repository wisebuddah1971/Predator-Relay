...
TS_CLIENT_ID = os.getenv("TS_CLIENT_ID", "P9ajTD2IAXvlLUZW87Nhcog4rIifVRox")
TS_CLIENT_SECRET = os.getenv("TS_CLIENT_SECRET", "oGqrXknxAm5d2rqddcI0nTiaK_qFHfdO7OMgKPwjm8kNF1DBvUDhEwABJ69_baJe")
TS_ACCOUNT = "210VMQ73"
